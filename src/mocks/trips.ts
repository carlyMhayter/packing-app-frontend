...
export const mockTripList: TripPublic[] = [
  mockTripDetail,
  {
    ...
    forecastTrip: {
      ...
      dayConditions: { conditions: { sunny: 8 }, total_hours: 8 },
      dayHigh: 90,
      dayLow: 70,
      nightConditions: { conditions: { clear: 8 }, total_hours: 8 },
      nightHigh: 75,
      nightLow: 62,
  ...
  },
  {
    ...
    forecastTrip: {
      ...
      dayConditions: { conditions: { partly_cloudy: 8 }, total_hours: 8 },
      dayHigh: 72,
      dayLow: 55,
      nightConditions: { conditions: { cloudy: 8 }, total_hours: 8 },
      nightHigh: 60,
      nightLow: 48,
      forecastDestinations: [],
    },
